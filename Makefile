...
deploy-mainnet :; SOLC_FLAGS="--optimize --optimize-runs=1000000" dapp --use solc:0.6.7 create IlkRegistry 0x35D1b3F3D7966A1DFe207aa4514C12a259A0492B {CAT-TBD} 0x65C79fcB50Ca1594B025960e539eD7A9a6D434A3
